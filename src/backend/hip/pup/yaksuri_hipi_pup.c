...
int yaksuri_hipi_ipack_with_stream(const void *inbuf, void *outbuf, uintptr_t count, yaksi_type_s * type,
                       yaksi_info_s * info, yaksa_op_t op, int target, void *stream_p)
{
    int rc = YAKSA_SUCCESS;
...
int yaksuri_hipi_iunpack_with_stream(const void *inbuf, void *outbuf, uintptr_t count, yaksi_type_s * type,
                                     yaksi_info_s * info, yaksa_op_t op, int target, void *stream_p)
{
    int rc = YAKSA_SUCCESS;
    hipStream_t stream = *(hipStream_t *) stream_p;
